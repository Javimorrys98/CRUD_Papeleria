...
public class TablapapeleriaJpaController implements Serializable {
    ...
    public List<Tablapapeleria> findTablapapeleriaCodigo(String codigo){
        EntityManager em = getEntityManager();
        TypedQuery<Tablapapeleria> tq=em.createNamedQuery("Tablapapeleria.findByCodigo", Tablapapeleria.class);
